...
export default new Router({
    ...
    routes: [{
        ...
        },
        {
            ...
            name: 'UpdateShipper',
            component: () =>
                import ( /* webpackChunkName: "about" */ '../views/UpdateShipper.vue')
        ...
        },
        {
            ...
            component: () =>
                import ( /* webpackChunkName: "about" */ '../views/SubmitExtenInfor.vue')
        ...
        },
        {
            ...
            name: 'RatingShipper',
            component: () =>
                import ( /* webpackChunkName: "about" */ '../views/RatingShipper.vue')
        ...
        },
        {
            ...
            component: () =>
                import ( /* webpackChunkName: "about" */ '../views/RateofShiper.vue')
        ...
        },
        {
            ...
            name: "ProductManage",
            component: () =>
                import ( /* webpackChunkName: "about" */ "../views/ProductManage.vue")
        },
    ]
});